...
//			deleteManager();
	...
	private static void updateManager() throws FileNotFoundException, IOException, SQLException {
		UserController uc = new UserController();
		System.out.println(uc.updateManager());
	}
	...
	private static void insertManager() throws FileNotFoundException, IOException, SQLException, ClassNotFoundException {
		UserController uc = new UserController();
		System.out.println(uc.insertManager());
	}
}
