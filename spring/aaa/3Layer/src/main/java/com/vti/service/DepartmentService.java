...
public class DepartmentService implements IDepartmentService {
	...
	public List<Department> getAllDepartments(int page, int size, String sortType, String sortField, String searchField,
			String value,int from,int to) {
		return repository.getAllDepartments(page,size,sortType,sortField,searchField,value,from,to);
	}
